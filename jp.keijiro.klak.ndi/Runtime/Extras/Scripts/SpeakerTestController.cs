...
{
    [FormerlySerializedAs("_NdiSender")] [SerializeField]
    private NdiSender _ndiSender;

    [Header("Default Speaker Setup")] public GameObject mono;
    ...
    private void Update()
    {
        ...
        {
            if ((_ndiSender.audioMode == NdiSender.AudioMode.SpeakerConfigAsset
            ...
            if (_ndiSender.audioMode == NdiSender.AudioMode.ObjectBased &&
                _currentTestSpeakers.Count != _ndiSender.maxObjectBasedChannels)
                ActivateBySenderAudioMode(_ndiSender);
        }
    }
    ...
    public void ActivateBySenderAudioMode(NdiSender sender)
    {
        ...
        switch (sender.audioMode)
        {
            case NdiSender.AudioMode.AudioListener:
                ...
                break;
            case NdiSender.AudioMode.VirtualQuad:
                ActivateQuad();
                break;
            case NdiSender.AudioMode.Virtual5Point1:
                Activate5_1();
                break;
            case NdiSender.AudioMode.Virtual7Point1:
                Activate7_1();
                break;
            case NdiSender.AudioMode.Virtual32Array:
            case NdiSender.AudioMode.SpeakerConfigAsset:
            case NdiSender.AudioMode.CustomVirtualAudioSetup:    

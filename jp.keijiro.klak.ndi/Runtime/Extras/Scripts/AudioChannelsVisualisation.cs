...
public abstract class AudioChannelsVisualisation : MonoBehaviour
{
    ...
    protected abstract float[] GetChannelsData();
    
    // Update is called once per frame
    void Update()
    {
        var channels = GetChannelsData();
        if (channels == null)
        {
        ...
        {
            _audioChannelsActiveImages[i].color = channels[i] > 0.001f ? _activeColor : _inactiveColor;
